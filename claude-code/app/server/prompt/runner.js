...
const READ_SYSTEM_PROMPT = [
  ...
  'HassClimateSetTemperature), targets must be entity ids, and risk must be',
  '"sensitive" or "low". Set risk "sensitive" when the action is consequential',
  'or security-relevant — locks, doors, gates, garage, covers, alarms, valves,',
  'water heaters, or any network / router / access-point or device-configuration',
  'control (reboot, firmware or software update, PoE), or anything hard to undo',
  'or affecting safety, security or access. Set "low" only for clearly harmless',
  'everyday actions (lights, TV / media, fans, air purifier, scenes, comfort).',
  'When unsure, use "sensitive". The user may confirm before anything runs.',
